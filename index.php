...
<div id="container">
	...
	$boxes = array(
		...
		'plugins' => array(
			...
			'desc' => 'I released a lot of <span class="highlight">free plugins</span> to make your everyday life with WordPress easier. On the road to <span class="highlight">one million downloads</span>!',
			'type' => 'project',
		),
		'tshirt' => array(
			'title'=> 'T-Shirts',
